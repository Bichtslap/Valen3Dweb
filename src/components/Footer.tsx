...
import { Instagram, Linkedin, Youtube, Terminal } from 'lucide-react';
        ...
        <div className="flex flex-col items-center text-center mb-12">
            ...
            <a href="#home" className="mb-6">
                <svg id="Layer_4" data-name="Layer 4" xmlns="http://www.w3.org/2000/svg" 
                    ...
                    className="h-16 w-auto" // Tamaño ajustado para el footer
                    fill="white"
                >
            ...
            <p className="text-gray-400 mb-8 max-w-md font-mono text-sm leading-relaxed mx-auto">
              <span className="text-cyan-400">&gt;</span> Soluciones creativas para un mundo digital.
            </p>
